...
public class Kms_BigCommentActionCommand1 implements MCommand {
	...
	public void execute(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		dao.bigCommentAction1(fid, f_cid, f_pid, fref, fstep, freforder, ftitle, fcontent, fmotherid, 
				fanswernum,fsteporder);
	}
